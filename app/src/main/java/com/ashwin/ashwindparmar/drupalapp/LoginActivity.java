...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        HttpPost httppost = new HttpPost("http://dev-iot-ashwin.pantheonsite.io/android/api/v1/user/login.json");

        UserLoginTask(String email, String password) {
            resultText = "LOGIN: " + email + ":" + password;
            mEmail = email;
            mPassword = password;
        }
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                json.put("username", mEmail.toString().trim());
                json.put("password", mPassword.toString().trim());
                ...
                //Toast.makeText(LoginActivity.this, "Response: " + jsonResponse, Toast.LENGTH_LONG).show();
                ...
                //Toast.makeText(LoginActivity.this, "Error adding article" + e.getMessage(), Toast.LENGTH_LONG).show();
                resultText = "Error adding article" + e.getMessage();
            }
